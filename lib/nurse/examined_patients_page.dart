...
class _NurseExaminedPatientsPageState extends State<NurseExaminedPatientsPage> {
  ...
  final String _allExaminationsApi = 'http://localhost:3000/all-examinations-full';
  final String _examinationFullApi = 'http://localhost:3000/examination-full';
  final String _patientsApi = 'http://localhost:3000/patients';
